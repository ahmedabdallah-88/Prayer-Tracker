...
window.App.Config = {
    ...
    T: {
        ...
        'qada_already_prayed': { ar: 'أيام قضاء سبق أداؤها', en: 'Qada days already completed' },
        'qada_already_prayed_hint': { ar: 'عدد الأيام التي قضيتها قبل استخدام التطبيق', en: 'Days you already made up before using this app' },
