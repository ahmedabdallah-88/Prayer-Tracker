...
window.App.Azkar = (function() {
    ...
    function updateAzkarTracker() {
        ...
        for (var day = 1; day <= daysInMonth; day++) {
            ...
            if (Storage.isFutureDate(day, month, year)) {
                ...
                if (catData[day]) {
                    ...
                    dayBox.style.background = 'linear-gradient(135deg, var(--blue), #38BDF8)';
        ...
        legend.innerHTML =
            '<div class="legend-item"><div class="legend-dot" style="background:linear-gradient(135deg,var(--blue),#38BDF8);"><span class="material-symbols-rounded" style="font-size:10px;color:white;">check</span></div><span>' + (currentLang === 'ar' ? 'تم' : 'Done') + '</span></div>' +
