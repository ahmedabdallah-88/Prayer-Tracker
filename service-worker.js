// Prayer Tracker PWA — Service Worker v298
const CACHE_NAME = 'salah-tracker-v298';
const ASSETS = [
    './',
    './index.html',
    './manifest.json',
    // CSS (versioned)
    './css/main.css?v=298',
    './css/themes.css?v=298',
    './css/dashboard.css?v=298',
    './css/splash.css?v=298',
    // JS modules (dependency order)
    './js/config.js?v=298',
    './js/storage.js?v=298',
    './js/hijri-calendar.js?v=298',
    './js/ui-utils.js?v=298',
    './js/i18n.js?v=298',
    './js/themes.js?v=298',
    './js/profiles.js?v=298',
    './js/female-features.js?v=298',
    './js/fard-tracker.js?v=298',
    './js/sunnah-tracker.js?v=298',
    './js/jamaah-tracker.js?v=298',
    './js/prayer-streaks.js?v=298',
    './js/weekly-view.js?v=298',
    './js/fasting-tracker.js?v=298',
    './js/prayer-times.js?v=298',
    './js/notifications.js?v=298',
    './js/azkar-tracker.js?v=298',
    './js/svg-charts.js?v=298',
    './js/info-tooltips.js?v=298',
    './js/qada-report.js?v=298',
    './js/qada-calculator.js?v=298',
    './js/qada-tracker.js?v=298',
    './js/qada-dashboard.js?v=298',
    './js/dashboard.js?v=298',
    './js/year-overview.js?v=298',
    './js/data-io.js?v=298',
    './js/onboarding.js?v=298',
    './js/app.js?v=298',
    // Icons
