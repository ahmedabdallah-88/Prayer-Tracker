// Prayer Tracker PWA — Service Worker v300
const CACHE_NAME = 'salah-tracker-v300';
const ASSETS = [
    './',
    './index.html',
    './manifest.json',
    // CSS (versioned)
    './css/main.css?v=300',
    './css/themes.css?v=300',
    './css/dashboard.css?v=300',
    './css/splash.css?v=300',
    // JS modules (dependency order)
    './js/config.js?v=300',
    './js/storage.js?v=300',
    './js/hijri-calendar.js?v=300',
    './js/ui-utils.js?v=300',
    './js/i18n.js?v=300',
    './js/themes.js?v=300',
    './js/profiles.js?v=300',
    './js/female-features.js?v=300',
    './js/fard-tracker.js?v=300',
    './js/sunnah-tracker.js?v=300',
    './js/jamaah-tracker.js?v=300',
    './js/prayer-streaks.js?v=300',
    './js/weekly-view.js?v=300',
    './js/fasting-tracker.js?v=300',
    './js/prayer-times.js?v=300',
    './js/missed-prayer-notif.js?v=300',
    './js/notifications.js?v=300',
    './js/azkar-tracker.js?v=300',
    './js/svg-charts.js?v=300',
    './js/info-tooltips.js?v=300',
    './js/qada-report.js?v=300',
    './js/qada-calculator.js?v=300',
    './js/qada-tracker.js?v=300',
    './js/qada-dashboard.js?v=300',
    './js/dashboard.js?v=300',
    './js/year-overview.js?v=300',
    './js/data-io.js?v=300',
    './js/onboarding.js?v=300',
    './js/app.js?v=300',
    // Icons
