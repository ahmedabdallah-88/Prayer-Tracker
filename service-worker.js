// Prayer Tracker PWA — Service Worker v318
const CACHE_NAME = 'salah-tracker-v318';
const ASSETS = [
    './',
    './index.html',
    './manifest.json',
    // CSS (versioned)
    './css/main.css?v=318',
    './css/themes.css?v=318',
    './css/dashboard.css?v=318',
    './css/splash.css?v=318',
    // JS modules (dependency order)
    './js/config.js?v=318',
    './js/storage.js?v=318',
    './js/hijri-calendar.js?v=318',
    './js/ui-utils.js?v=318',
    './js/i18n.js?v=318',
    './js/themes.js?v=318',
    './js/profiles.js?v=318',
    './js/female-features.js?v=318',
    './js/fard-tracker.js?v=318',
    './js/sunnah-tracker.js?v=318',
    './js/jamaah-tracker.js?v=318',
    './js/prayer-streaks.js?v=318',
    './js/weekly-view.js?v=318',
    './js/fasting-tracker.js?v=318',
    './js/prayer-times.js?v=318',
    './js/missed-prayer-notif.js?v=318',
    './js/notifications.js?v=318',
    './js/azkar-tracker.js?v=318',
    './js/svg-charts.js?v=318',
    './js/info-tooltips.js?v=318',
    './js/qada-report.js?v=318',
    './js/qada-calculator.js?v=318',
    './js/qada-tracker.js?v=318',
    './js/qada-dashboard.js?v=318',
    './js/dashboard.js?v=318',
    './js/year-overview.js?v=318',
    './js/data-io.js?v=318',
    './js/onboarding.js?v=318',
    './js/app.js?v=318',
    // Icons
