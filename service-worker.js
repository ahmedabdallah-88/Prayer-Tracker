// Prayer Tracker PWA — Service Worker v293
const CACHE_NAME = 'salah-tracker-v293';
const ASSETS = [
    './',
    './index.html',
    './manifest.json',
    // CSS (versioned)
    './css/main.css?v=293',
    './css/themes.css?v=293',
    './css/dashboard.css?v=293',
    './css/splash.css?v=293',
    // JS modules (dependency order)
    './js/config.js?v=293',
    './js/storage.js?v=293',
    './js/hijri-calendar.js?v=293',
    './js/ui-utils.js?v=293',
    './js/i18n.js?v=293',
    './js/themes.js?v=293',
    './js/profiles.js?v=293',
    './js/female-features.js?v=293',
    './js/fard-tracker.js?v=293',
    './js/sunnah-tracker.js?v=293',
    './js/jamaah-tracker.js?v=293',
    './js/prayer-streaks.js?v=293',
    './js/weekly-view.js?v=293',
    './js/fasting-tracker.js?v=293',
    './js/prayer-times.js?v=293',
    './js/notifications.js?v=293',
    './js/azkar-tracker.js?v=293',
    './js/svg-charts.js?v=293',
    './js/info-tooltips.js?v=293',
    './js/qada-report.js?v=293',
    './js/qada-calculator.js?v=293',
    './js/qada-tracker.js?v=293',
    './js/qada-dashboard.js?v=293',
    './js/dashboard.js?v=293',
    './js/year-overview.js?v=293',
    './js/data-io.js?v=293',
    './js/onboarding.js?v=293',
    './js/app.js?v=293',
    // Icons
