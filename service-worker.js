// Prayer Tracker PWA — Service Worker v225
const CACHE_NAME = 'salah-tracker-v225';
const ASSETS = [
    './',
    './index.html',
    './manifest.json',
    // CSS (versioned)
    './css/main.css?v=225',
    './css/themes.css?v=225',
    './css/dashboard.css?v=225',
    './css/splash.css?v=225',
    // JS modules (dependency order)
    './js/config.js?v=225',
    './js/storage.js?v=225',
    './js/hijri-calendar.js?v=225',
    './js/ui-utils.js?v=225',
    './js/i18n.js?v=225',
    './js/themes.js?v=225',
    './js/profiles.js?v=225',
    './js/female-features.js?v=225',
    './js/fard-tracker.js?v=225',
    './js/sunnah-tracker.js?v=225',
    './js/jamaah-tracker.js?v=225',
    './js/weekly-view.js?v=225',
    './js/fasting-tracker.js?v=225',
    './js/prayer-times.js?v=225',
    './js/notifications.js?v=225',
    './js/azkar-tracker.js?v=225',
    './js/svg-charts.js?v=225',
    './js/info-tooltips.js?v=225',
    './js/qada-report.js?v=225',
    './js/qada-calculator.js?v=225',
    './js/qada-tracker.js?v=225',
    './js/qada-dashboard.js?v=225',
    './js/dashboard.js?v=225',
    './js/year-overview.js?v=225',
    './js/data-io.js?v=225',
    './js/onboarding.js?v=225',
    './js/app.js?v=225',
    // Icons
