// Prayer Tracker PWA — Service Worker v303
const CACHE_NAME = 'salah-tracker-v303';
const ASSETS = [
    './',
    './index.html',
    './manifest.json',
    // CSS (versioned)
    './css/main.css?v=303',
    './css/themes.css?v=303',
    './css/dashboard.css?v=303',
    './css/splash.css?v=303',
    // JS modules (dependency order)
    './js/config.js?v=303',
    './js/storage.js?v=303',
    './js/hijri-calendar.js?v=303',
    './js/ui-utils.js?v=303',
    './js/i18n.js?v=303',
    './js/themes.js?v=303',
    './js/profiles.js?v=303',
    './js/female-features.js?v=303',
    './js/fard-tracker.js?v=303',
    './js/sunnah-tracker.js?v=303',
    './js/jamaah-tracker.js?v=303',
    './js/prayer-streaks.js?v=303',
    './js/weekly-view.js?v=303',
    './js/fasting-tracker.js?v=303',
    './js/prayer-times.js?v=303',
    './js/missed-prayer-notif.js?v=303',
    './js/notifications.js?v=303',
    './js/azkar-tracker.js?v=303',
    './js/svg-charts.js?v=303',
    './js/info-tooltips.js?v=303',
    './js/qada-report.js?v=303',
    './js/qada-calculator.js?v=303',
    './js/qada-tracker.js?v=303',
    './js/qada-dashboard.js?v=303',
    './js/dashboard.js?v=303',
    './js/year-overview.js?v=303',
    './js/data-io.js?v=303',
    './js/onboarding.js?v=303',
    './js/app.js?v=303',
    // Icons
