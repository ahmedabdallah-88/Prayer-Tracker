// Prayer Tracker PWA — Service Worker v292
const CACHE_NAME = 'salah-tracker-v292';
const ASSETS = [
    './',
    './index.html',
    './manifest.json',
    // CSS (versioned)
    './css/main.css?v=292',
    './css/themes.css?v=292',
    './css/dashboard.css?v=292',
    './css/splash.css?v=292',
    // JS modules (dependency order)
    './js/config.js?v=292',
    './js/storage.js?v=292',
    './js/hijri-calendar.js?v=292',
    './js/ui-utils.js?v=292',
    './js/i18n.js?v=292',
    './js/themes.js?v=292',
    './js/profiles.js?v=292',
    './js/female-features.js?v=292',
    './js/fard-tracker.js?v=292',
    './js/sunnah-tracker.js?v=292',
    './js/jamaah-tracker.js?v=292',
    './js/prayer-streaks.js?v=292',
    './js/weekly-view.js?v=292',
    './js/fasting-tracker.js?v=292',
    './js/prayer-times.js?v=292',
    './js/notifications.js?v=292',
    './js/azkar-tracker.js?v=292',
    './js/svg-charts.js?v=292',
    './js/info-tooltips.js?v=292',
    './js/qada-report.js?v=292',
    './js/qada-calculator.js?v=292',
    './js/qada-tracker.js?v=292',
    './js/qada-dashboard.js?v=292',
    './js/dashboard.js?v=292',
    './js/year-overview.js?v=292',
    './js/data-io.js?v=292',
    './js/onboarding.js?v=292',
    './js/app.js?v=292',
    // Icons
