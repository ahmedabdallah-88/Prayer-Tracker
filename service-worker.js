// Prayer Tracker PWA — Service Worker v202
const CACHE_NAME = 'salah-tracker-v202';
const ASSETS = [
    './',
    './index.html',
    './manifest.json',
    // CSS (versioned)
    './css/main.css?v=202',
    './css/themes.css?v=202',
    './css/dashboard.css?v=202',
    './css/splash.css?v=202',
    // JS modules (dependency order)
    './js/config.js?v=202',
    './js/storage.js?v=202',
    './js/hijri-calendar.js?v=202',
    './js/ui-utils.js?v=202',
    './js/i18n.js?v=202',
    './js/themes.js?v=202',
    './js/profiles.js?v=202',
    './js/female-features.js?v=202',
    './js/fard-tracker.js?v=202',
    './js/sunnah-tracker.js?v=202',
    './js/jamaah-tracker.js?v=202',
    './js/weekly-view.js?v=202',
    './js/fasting-tracker.js?v=202',
    './js/prayer-times.js?v=202',
    './js/notifications.js?v=202',
    './js/azkar-tracker.js?v=202',
    './js/svg-charts.js?v=202',
    './js/info-tooltips.js?v=202',
    './js/qada-report.js?v=202',
    './js/dashboard.js?v=202',
    './js/year-overview.js?v=202',
    './js/data-io.js?v=202',
    './js/onboarding.js?v=202',
    './js/app.js?v=202',
    // Icons
