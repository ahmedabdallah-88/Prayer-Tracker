// Prayer Tracker PWA — Service Worker v320
const CACHE_NAME = 'salah-tracker-v320';
const ASSETS = [
    './',
    './index.html',
    './manifest.json',
    // CSS (versioned)
    './css/main.css?v=320',
    './css/themes.css?v=320',
    './css/dashboard.css?v=320',
    './css/splash.css?v=320',
    // JS modules (dependency order)
    './js/config.js?v=320',
    './js/storage.js?v=320',
    './js/hijri-calendar.js?v=320',
    './js/ui-utils.js?v=320',
    './js/i18n.js?v=320',
    './js/themes.js?v=320',
    './js/profiles.js?v=320',
    './js/female-features.js?v=320',
    './js/fard-tracker.js?v=320',
    './js/sunnah-tracker.js?v=320',
    './js/jamaah-tracker.js?v=320',
    './js/prayer-streaks.js?v=320',
    './js/weekly-view.js?v=320',
    './js/fasting-tracker.js?v=320',
    './js/prayer-times.js?v=320',
    './js/missed-prayer-notif.js?v=320',
    './js/notifications.js?v=320',
    './js/azkar-tracker.js?v=320',
    './js/svg-charts.js?v=320',
    './js/info-tooltips.js?v=320',
    './js/qada-report.js?v=320',
    './js/qada-calculator.js?v=320',
    './js/qada-tracker.js?v=320',
    './js/qada-dashboard.js?v=320',
    './js/dashboard.js?v=320',
    './js/year-overview.js?v=320',
    './js/data-io.js?v=320',
    './js/onboarding.js?v=320',
    './js/app.js?v=320',
    // Icons
