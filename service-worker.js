// Prayer Tracker PWA — Service Worker v308
const CACHE_NAME = 'salah-tracker-v308';
const ASSETS = [
    './',
    './index.html',
    './manifest.json',
