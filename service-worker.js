// Prayer Tracker PWA — Service Worker v327
const CACHE_NAME = 'salah-tracker-v327';
const ASSETS = [
    './',
    './index.html',
    './manifest.json',
    // CSS (versioned)
    './css/main.css?v=327',
    './css/themes.css?v=327',
    './css/dashboard.css?v=327',
    './css/splash.css?v=327',
    // JS modules (dependency order)
    './js/config.js?v=327',
    './js/storage.js?v=327',
    './js/hijri-calendar.js?v=327',
    './js/ui-utils.js?v=327',
    './js/i18n.js?v=327',
    './js/themes.js?v=327',
    './js/profiles.js?v=327',
    './js/female-features.js?v=327',
    './js/tracker-utils.js?v=327',
    './js/fard-tracker.js?v=327',
    './js/sunnah-tracker.js?v=327',
    './js/jamaah-tracker.js?v=327',
    './js/prayer-streaks.js?v=327',
    './js/weekly-view.js?v=327',
    './js/fasting-tracker.js?v=327',
    './js/prayer-times.js?v=327',
    './js/missed-prayer-notif.js?v=327',
    './js/notification-center.js?v=327',
    './js/notifications.js?v=327',
    './js/azkar-tracker.js?v=327',
    './js/svg-charts.js?v=327',
    './js/info-tooltips.js?v=327',
    './js/qada-report.js?v=327',
    './js/qada-calculator.js?v=327',
    './js/qada-tracker.js?v=327',
    './js/qada-dashboard.js?v=327',
    './js/dashboard.js?v=327',
    './js/year-overview.js?v=327',
    './js/data-io.js?v=327',
    './js/onboarding.js?v=327',
    './js/app.js?v=327',
    // Icons
