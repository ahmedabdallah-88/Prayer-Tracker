// Prayer Tracker PWA — Service Worker v203
const CACHE_NAME = 'salah-tracker-v203';
const ASSETS = [
    './',
    './index.html',
    './manifest.json',
    // CSS (versioned)
    './css/main.css?v=203',
    './css/themes.css?v=203',
    './css/dashboard.css?v=203',
    './css/splash.css?v=203',
    // JS modules (dependency order)
    './js/config.js?v=203',
    './js/storage.js?v=203',
    './js/hijri-calendar.js?v=203',
    './js/ui-utils.js?v=203',
    './js/i18n.js?v=203',
    './js/themes.js?v=203',
    './js/profiles.js?v=203',
    './js/female-features.js?v=203',
    './js/fard-tracker.js?v=203',
    './js/sunnah-tracker.js?v=203',
    './js/jamaah-tracker.js?v=203',
    './js/weekly-view.js?v=203',
    './js/fasting-tracker.js?v=203',
    './js/prayer-times.js?v=203',
    './js/notifications.js?v=203',
    './js/azkar-tracker.js?v=203',
    './js/svg-charts.js?v=203',
    './js/info-tooltips.js?v=203',
    './js/qada-report.js?v=203',
    './js/dashboard.js?v=203',
    './js/year-overview.js?v=203',
    './js/data-io.js?v=203',
    './js/onboarding.js?v=203',
    './js/app.js?v=203',
    // Icons
