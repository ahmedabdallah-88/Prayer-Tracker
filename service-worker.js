// Prayer Tracker PWA — Service Worker v332
const CACHE_NAME = 'salah-tracker-v332';
const ASSETS = [
    './',
    './index.html',
    './manifest.json',
    // CSS (versioned)
    './css/main.css?v=332',
    './css/themes.css?v=332',
    './css/dashboard.css?v=332',
    './css/splash.css?v=332',
    // JS modules (dependency order)
    './js/config.js?v=332',
    './js/storage.js?v=332',
    './js/hijri-calendar.js?v=332',
    './js/ui-utils.js?v=332',
    './js/i18n.js?v=332',
    './js/themes.js?v=332',
    './js/profiles.js?v=332',
    './js/female-features.js?v=332',
    './js/tracker-utils.js?v=332',
    './js/fard-tracker.js?v=332',
    './js/sunnah-tracker.js?v=332',
    './js/jamaah-tracker.js?v=332',
    './js/prayer-streaks.js?v=332',
    './js/weekly-view.js?v=332',
    './js/fasting-tracker.js?v=332',
    './js/prayer-times.js?v=332',
    './js/missed-prayer-notif.js?v=332',
    './js/notification-center.js?v=332',
    './js/notifications.js?v=332',
    './js/azkar-tracker.js?v=332',
    './js/svg-charts.js?v=332',
    './js/info-tooltips.js?v=332',
    './js/qada-report.js?v=332',
    './js/qada-calculator.js?v=332',
    './js/qada-tracker.js?v=332',
    './js/qada-dashboard.js?v=332',
    './js/dashboard.js?v=332',
    './js/year-overview.js?v=332',
    './js/data-io.js?v=332',
    './js/onboarding.js?v=332',
    './js/app.js?v=332',
    // Icons
