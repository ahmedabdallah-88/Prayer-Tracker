// Prayer Tracker PWA — Service Worker v324
const CACHE_NAME = 'salah-tracker-v324';
const ASSETS = [
    './',
    './index.html',
    './manifest.json',
    // CSS (versioned)
    './css/main.css?v=324',
    './css/themes.css?v=324',
    './css/dashboard.css?v=324',
    './css/splash.css?v=324',
    // JS modules (dependency order)
    './js/config.js?v=324',
    './js/storage.js?v=324',
    './js/hijri-calendar.js?v=324',
    './js/ui-utils.js?v=324',
    './js/i18n.js?v=324',
    './js/themes.js?v=324',
    './js/profiles.js?v=324',
    './js/female-features.js?v=324',
    './js/fard-tracker.js?v=324',
    './js/sunnah-tracker.js?v=324',
    './js/jamaah-tracker.js?v=324',
    './js/prayer-streaks.js?v=324',
    './js/weekly-view.js?v=324',
    './js/fasting-tracker.js?v=324',
    './js/prayer-times.js?v=324',
    './js/missed-prayer-notif.js?v=324',
    './js/notifications.js?v=324',
    './js/azkar-tracker.js?v=324',
    './js/svg-charts.js?v=324',
    './js/info-tooltips.js?v=324',
    './js/qada-report.js?v=324',
    './js/qada-calculator.js?v=324',
    './js/qada-tracker.js?v=324',
    './js/qada-dashboard.js?v=324',
    './js/dashboard.js?v=324',
    './js/year-overview.js?v=324',
    './js/data-io.js?v=324',
    './js/onboarding.js?v=324',
    './js/app.js?v=324',
    // Icons
