// Prayer Tracker PWA — Service Worker v243
const CACHE_NAME = 'salah-tracker-v243';
const ASSETS = [
    './',
    './index.html',
    './manifest.json',
    // CSS (versioned)
    './css/main.css?v=243',
    './css/themes.css?v=243',
    './css/dashboard.css?v=243',
    './css/splash.css?v=243',
    // JS modules (dependency order)
    './js/config.js?v=243',
    './js/storage.js?v=243',
    './js/hijri-calendar.js?v=243',
    './js/ui-utils.js?v=243',
    './js/i18n.js?v=243',
    './js/themes.js?v=243',
    './js/profiles.js?v=243',
    './js/female-features.js?v=243',
    './js/fard-tracker.js?v=243',
    './js/sunnah-tracker.js?v=243',
    './js/jamaah-tracker.js?v=243',
    './js/weekly-view.js?v=243',
    './js/fasting-tracker.js?v=243',
    './js/prayer-times.js?v=243',
    './js/notifications.js?v=243',
    './js/azkar-tracker.js?v=243',
    './js/svg-charts.js?v=243',
    './js/info-tooltips.js?v=243',
    './js/qada-report.js?v=243',
    './js/qada-calculator.js?v=243',
    './js/qada-tracker.js?v=243',
    './js/qada-dashboard.js?v=243',
    './js/dashboard.js?v=243',
    './js/year-overview.js?v=243',
    './js/data-io.js?v=243',
    './js/onboarding.js?v=243',
    './js/app.js?v=243',
    // Icons
