// Prayer Tracker PWA — Service Worker v302
const CACHE_NAME = 'salah-tracker-v302';
const ASSETS = [
    './',
    './index.html',
    './manifest.json',
    // CSS (versioned)
    './css/main.css?v=302',
    './css/themes.css?v=302',
    './css/dashboard.css?v=302',
    './css/splash.css?v=302',
    // JS modules (dependency order)
    './js/config.js?v=302',
    './js/storage.js?v=302',
    './js/hijri-calendar.js?v=302',
    './js/ui-utils.js?v=302',
    './js/i18n.js?v=302',
    './js/themes.js?v=302',
    './js/profiles.js?v=302',
    './js/female-features.js?v=302',
    './js/fard-tracker.js?v=302',
    './js/sunnah-tracker.js?v=302',
    './js/jamaah-tracker.js?v=302',
    './js/prayer-streaks.js?v=302',
    './js/weekly-view.js?v=302',
    './js/fasting-tracker.js?v=302',
    './js/prayer-times.js?v=302',
    './js/missed-prayer-notif.js?v=302',
    './js/notifications.js?v=302',
    './js/azkar-tracker.js?v=302',
    './js/svg-charts.js?v=302',
    './js/info-tooltips.js?v=302',
    './js/qada-report.js?v=302',
    './js/qada-calculator.js?v=302',
    './js/qada-tracker.js?v=302',
    './js/qada-dashboard.js?v=302',
    './js/dashboard.js?v=302',
    './js/year-overview.js?v=302',
    './js/data-io.js?v=302',
    './js/onboarding.js?v=302',
    './js/app.js?v=302',
    // Icons
