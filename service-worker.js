// Prayer Tracker PWA — Service Worker v322
const CACHE_NAME = 'salah-tracker-v322';
const ASSETS = [
    './',
    './index.html',
    './manifest.json',
    // CSS (versioned)
    './css/main.css?v=322',
    './css/themes.css?v=322',
    './css/dashboard.css?v=322',
    './css/splash.css?v=322',
    // JS modules (dependency order)
    './js/config.js?v=322',
    './js/storage.js?v=322',
    './js/hijri-calendar.js?v=322',
    './js/ui-utils.js?v=322',
    './js/i18n.js?v=322',
    './js/themes.js?v=322',
    './js/profiles.js?v=322',
    './js/female-features.js?v=322',
    './js/fard-tracker.js?v=322',
    './js/sunnah-tracker.js?v=322',
    './js/jamaah-tracker.js?v=322',
    './js/prayer-streaks.js?v=322',
    './js/weekly-view.js?v=322',
    './js/fasting-tracker.js?v=322',
    './js/prayer-times.js?v=322',
    './js/missed-prayer-notif.js?v=322',
    './js/notifications.js?v=322',
    './js/azkar-tracker.js?v=322',
    './js/svg-charts.js?v=322',
    './js/info-tooltips.js?v=322',
    './js/qada-report.js?v=322',
    './js/qada-calculator.js?v=322',
    './js/qada-tracker.js?v=322',
    './js/qada-dashboard.js?v=322',
    './js/dashboard.js?v=322',
    './js/year-overview.js?v=322',
    './js/data-io.js?v=322',
    './js/onboarding.js?v=322',
    './js/app.js?v=322',
    // Icons
