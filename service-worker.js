// Prayer Tracker PWA — Service Worker v223
const CACHE_NAME = 'salah-tracker-v223';
const ASSETS = [
    './',
    './index.html',
    './manifest.json',
    // CSS (versioned)
    './css/main.css?v=215',
    './css/themes.css?v=215',
    './css/dashboard.css?v=215',
    './css/splash.css?v=215',
    // JS modules (dependency order)
    './js/config.js?v=215',
    './js/storage.js?v=215',
    './js/hijri-calendar.js?v=215',
    './js/ui-utils.js?v=215',
    './js/i18n.js?v=215',
    './js/themes.js?v=215',
    './js/profiles.js?v=215',
    './js/female-features.js?v=215',
    './js/fard-tracker.js?v=215',
    './js/sunnah-tracker.js?v=215',
    './js/jamaah-tracker.js?v=215',
    './js/weekly-view.js?v=215',
    './js/fasting-tracker.js?v=215',
    './js/prayer-times.js?v=215',
    './js/notifications.js?v=215',
    './js/azkar-tracker.js?v=215',
    './js/svg-charts.js?v=215',
    './js/info-tooltips.js?v=215',
    './js/qada-report.js?v=215',
    './js/qada-calculator.js?v=215',
    './js/qada-tracker.js?v=215',
    './js/qada-dashboard.js?v=215',
    './js/dashboard.js?v=215',
    './js/year-overview.js?v=215',
    './js/data-io.js?v=215',
    './js/onboarding.js?v=215',
    './js/app.js?v=215',
    // Icons
