// Prayer Tracker PWA — Service Worker v226
const CACHE_NAME = 'salah-tracker-v226';
const ASSETS = [
    './',
    './index.html',
    './manifest.json',
    // CSS (versioned)
    './css/main.css?v=226',
    './css/themes.css?v=226',
    './css/dashboard.css?v=226',
    './css/splash.css?v=226',
    // JS modules (dependency order)
    './js/config.js?v=226',
    './js/storage.js?v=226',
    './js/hijri-calendar.js?v=226',
    './js/ui-utils.js?v=226',
    './js/i18n.js?v=226',
    './js/themes.js?v=226',
    './js/profiles.js?v=226',
    './js/female-features.js?v=226',
    './js/fard-tracker.js?v=226',
    './js/sunnah-tracker.js?v=226',
    './js/jamaah-tracker.js?v=226',
    './js/weekly-view.js?v=226',
    './js/fasting-tracker.js?v=226',
    './js/prayer-times.js?v=226',
    './js/notifications.js?v=226',
    './js/azkar-tracker.js?v=226',
    './js/svg-charts.js?v=226',
    './js/info-tooltips.js?v=226',
    './js/qada-report.js?v=226',
    './js/qada-calculator.js?v=226',
    './js/qada-tracker.js?v=226',
    './js/qada-dashboard.js?v=226',
    './js/dashboard.js?v=226',
    './js/year-overview.js?v=226',
    './js/data-io.js?v=226',
    './js/onboarding.js?v=226',
    './js/app.js?v=226',
    // Icons
