// Prayer Tracker PWA — Service Worker v325
const CACHE_NAME = 'salah-tracker-v325';
const ASSETS = [
    './',
    './index.html',
    './manifest.json',
    // CSS (versioned)
    './css/main.css?v=325',
    './css/themes.css?v=325',
    './css/dashboard.css?v=325',
    './css/splash.css?v=325',
    // JS modules (dependency order)
    './js/config.js?v=325',
    './js/storage.js?v=325',
    './js/hijri-calendar.js?v=325',
    './js/ui-utils.js?v=325',
    './js/i18n.js?v=325',
    './js/themes.js?v=325',
    './js/profiles.js?v=325',
    './js/female-features.js?v=325',
    './js/tracker-utils.js?v=325',
    './js/fard-tracker.js?v=325',
    './js/sunnah-tracker.js?v=325',
    './js/jamaah-tracker.js?v=325',
    './js/prayer-streaks.js?v=325',
    './js/weekly-view.js?v=325',
    './js/fasting-tracker.js?v=325',
    './js/prayer-times.js?v=325',
    './js/missed-prayer-notif.js?v=325',
    './js/notifications.js?v=325',
    './js/azkar-tracker.js?v=325',
    './js/svg-charts.js?v=325',
    './js/info-tooltips.js?v=325',
    './js/qada-report.js?v=325',
    './js/qada-calculator.js?v=325',
    './js/qada-tracker.js?v=325',
    './js/qada-dashboard.js?v=325',
    './js/dashboard.js?v=325',
    './js/year-overview.js?v=325',
    './js/data-io.js?v=325',
    './js/onboarding.js?v=325',
    './js/app.js?v=325',
    // Icons
