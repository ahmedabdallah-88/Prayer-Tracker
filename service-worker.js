// Prayer Tracker PWA — Service Worker v299
const CACHE_NAME = 'salah-tracker-v299';
const ASSETS = [
    './',
    './index.html',
    './manifest.json',
    // CSS (versioned)
    './css/main.css?v=299',
    './css/themes.css?v=299',
    './css/dashboard.css?v=299',
    './css/splash.css?v=299',
    // JS modules (dependency order)
    './js/config.js?v=299',
    './js/storage.js?v=299',
    './js/hijri-calendar.js?v=299',
    './js/ui-utils.js?v=299',
    './js/i18n.js?v=299',
    './js/themes.js?v=299',
    './js/profiles.js?v=299',
    './js/female-features.js?v=299',
    './js/fard-tracker.js?v=299',
    './js/sunnah-tracker.js?v=299',
    './js/jamaah-tracker.js?v=299',
    './js/prayer-streaks.js?v=299',
    './js/weekly-view.js?v=299',
    './js/fasting-tracker.js?v=299',
    './js/prayer-times.js?v=299',
    './js/missed-prayer-notif.js?v=299',
    './js/notifications.js?v=299',
    './js/azkar-tracker.js?v=299',
    './js/svg-charts.js?v=299',
    './js/info-tooltips.js?v=299',
    './js/qada-report.js?v=299',
    './js/qada-calculator.js?v=299',
    './js/qada-tracker.js?v=299',
    './js/qada-dashboard.js?v=299',
    './js/dashboard.js?v=299',
    './js/year-overview.js?v=299',
    './js/data-io.js?v=299',
    './js/onboarding.js?v=299',
    './js/app.js?v=299',
    // Icons
