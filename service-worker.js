// Prayer Tracker PWA — Service Worker v326
const CACHE_NAME = 'salah-tracker-v326';
const ASSETS = [
    './',
    './index.html',
    './manifest.json',
    // CSS (versioned)
    './css/main.css?v=326',
    './css/themes.css?v=326',
    './css/dashboard.css?v=326',
    './css/splash.css?v=326',
    // JS modules (dependency order)
    './js/config.js?v=326',
    './js/storage.js?v=326',
    './js/hijri-calendar.js?v=326',
    './js/ui-utils.js?v=326',
    './js/i18n.js?v=326',
    './js/themes.js?v=326',
    './js/profiles.js?v=326',
    './js/female-features.js?v=326',
    './js/tracker-utils.js?v=326',
    './js/fard-tracker.js?v=326',
    './js/sunnah-tracker.js?v=326',
    './js/jamaah-tracker.js?v=326',
    './js/prayer-streaks.js?v=326',
    './js/weekly-view.js?v=326',
    './js/fasting-tracker.js?v=326',
    './js/prayer-times.js?v=326',
    './js/missed-prayer-notif.js?v=326',
    './js/notifications.js?v=326',
    './js/azkar-tracker.js?v=326',
    './js/svg-charts.js?v=326',
    './js/info-tooltips.js?v=326',
    './js/qada-report.js?v=326',
    './js/qada-calculator.js?v=326',
    './js/qada-tracker.js?v=326',
    './js/qada-dashboard.js?v=326',
    './js/dashboard.js?v=326',
    './js/year-overview.js?v=326',
    './js/data-io.js?v=326',
    './js/onboarding.js?v=326',
    './js/app.js?v=326',
    // Icons
