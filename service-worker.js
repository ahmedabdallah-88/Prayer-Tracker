// Prayer Tracker PWA — Service Worker v230
const CACHE_NAME = 'salah-tracker-v230';
const ASSETS = [
    './',
    './index.html',
    './manifest.json',
    // CSS (versioned)
    './css/main.css?v=228',
    './css/themes.css?v=228',
    './css/dashboard.css?v=228',
    './css/splash.css?v=228',
    // JS modules (dependency order)
    './js/config.js?v=228',
    './js/storage.js?v=228',
    './js/hijri-calendar.js?v=228',
    './js/ui-utils.js?v=228',
    './js/i18n.js?v=228',
    './js/themes.js?v=228',
    './js/profiles.js?v=228',
    './js/female-features.js?v=228',
    './js/fard-tracker.js?v=228',
    './js/sunnah-tracker.js?v=228',
    './js/jamaah-tracker.js?v=228',
    './js/weekly-view.js?v=228',
    './js/fasting-tracker.js?v=228',
    './js/prayer-times.js?v=228',
    './js/notifications.js?v=228',
    './js/azkar-tracker.js?v=228',
    './js/svg-charts.js?v=228',
    './js/info-tooltips.js?v=228',
    './js/qada-report.js?v=228',
    './js/qada-calculator.js?v=228',
    './js/qada-tracker.js?v=228',
    './js/qada-dashboard.js?v=228',
    './js/dashboard.js?v=228',
    './js/year-overview.js?v=228',
    './js/data-io.js?v=228',
    './js/onboarding.js?v=228',
    './js/app.js?v=228',
    // Icons
