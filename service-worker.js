// Prayer Tracker PWA — Service Worker v301
const CACHE_NAME = 'salah-tracker-v301';
const ASSETS = [
    './',
    './index.html',
    './manifest.json',
    // CSS (versioned)
    './css/main.css?v=301',
    './css/themes.css?v=301',
    './css/dashboard.css?v=301',
    './css/splash.css?v=301',
    // JS modules (dependency order)
    './js/config.js?v=301',
    './js/storage.js?v=301',
    './js/hijri-calendar.js?v=301',
    './js/ui-utils.js?v=301',
    './js/i18n.js?v=301',
    './js/themes.js?v=301',
    './js/profiles.js?v=301',
    './js/female-features.js?v=301',
    './js/fard-tracker.js?v=301',
    './js/sunnah-tracker.js?v=301',
    './js/jamaah-tracker.js?v=301',
    './js/prayer-streaks.js?v=301',
    './js/weekly-view.js?v=301',
    './js/fasting-tracker.js?v=301',
    './js/prayer-times.js?v=301',
    './js/missed-prayer-notif.js?v=301',
    './js/notifications.js?v=301',
    './js/azkar-tracker.js?v=301',
    './js/svg-charts.js?v=301',
    './js/info-tooltips.js?v=301',
    './js/qada-report.js?v=301',
    './js/qada-calculator.js?v=301',
    './js/qada-tracker.js?v=301',
    './js/qada-dashboard.js?v=301',
    './js/dashboard.js?v=301',
    './js/year-overview.js?v=301',
    './js/data-io.js?v=301',
    './js/onboarding.js?v=301',
    './js/app.js?v=301',
    // Icons
