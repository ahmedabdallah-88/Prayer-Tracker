// Prayer Tracker PWA — Service Worker v321
const CACHE_NAME = 'salah-tracker-v321';
const ASSETS = [
    './',
    './index.html',
    './manifest.json',
    // CSS (versioned)
    './css/main.css?v=321',
    './css/themes.css?v=321',
    './css/dashboard.css?v=321',
    './css/splash.css?v=321',
    // JS modules (dependency order)
    './js/config.js?v=321',
    './js/storage.js?v=321',
    './js/hijri-calendar.js?v=321',
    './js/ui-utils.js?v=321',
    './js/i18n.js?v=321',
    './js/themes.js?v=321',
    './js/profiles.js?v=321',
    './js/female-features.js?v=321',
    './js/fard-tracker.js?v=321',
    './js/sunnah-tracker.js?v=321',
    './js/jamaah-tracker.js?v=321',
    './js/prayer-streaks.js?v=321',
    './js/weekly-view.js?v=321',
    './js/fasting-tracker.js?v=321',
    './js/prayer-times.js?v=321',
    './js/missed-prayer-notif.js?v=321',
    './js/notifications.js?v=321',
    './js/azkar-tracker.js?v=321',
    './js/svg-charts.js?v=321',
    './js/info-tooltips.js?v=321',
    './js/qada-report.js?v=321',
    './js/qada-calculator.js?v=321',
    './js/qada-tracker.js?v=321',
    './js/qada-dashboard.js?v=321',
    './js/dashboard.js?v=321',
    './js/year-overview.js?v=321',
    './js/data-io.js?v=321',
    './js/onboarding.js?v=321',
    './js/app.js?v=321',
    // Icons
