// Prayer Tracker PWA — Service Worker v227
const CACHE_NAME = 'salah-tracker-v227';
const ASSETS = [
    './',
    './index.html',
    './manifest.json',
    // CSS (versioned)
    './css/main.css?v=227',
    './css/themes.css?v=227',
    './css/dashboard.css?v=227',
    './css/splash.css?v=227',
    // JS modules (dependency order)
    './js/config.js?v=227',
    './js/storage.js?v=227',
    './js/hijri-calendar.js?v=227',
    './js/ui-utils.js?v=227',
    './js/i18n.js?v=227',
    './js/themes.js?v=227',
    './js/profiles.js?v=227',
    './js/female-features.js?v=227',
    './js/fard-tracker.js?v=227',
    './js/sunnah-tracker.js?v=227',
    './js/jamaah-tracker.js?v=227',
    './js/weekly-view.js?v=227',
    './js/fasting-tracker.js?v=227',
    './js/prayer-times.js?v=227',
    './js/notifications.js?v=227',
    './js/azkar-tracker.js?v=227',
    './js/svg-charts.js?v=227',
    './js/info-tooltips.js?v=227',
    './js/qada-report.js?v=227',
    './js/qada-calculator.js?v=227',
    './js/qada-tracker.js?v=227',
    './js/qada-dashboard.js?v=227',
    './js/dashboard.js?v=227',
    './js/year-overview.js?v=227',
    './js/data-io.js?v=227',
    './js/onboarding.js?v=227',
    './js/app.js?v=227',
    // Icons
